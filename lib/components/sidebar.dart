...
class _SidebarState extends State<Sidebar> {
  ...
  Widget sidebarElement(String title, IconData icon, bool isActive, [Function? method]) {
          ...
          Align(
            ...
            child: Column(
              children: [
                ...
                _isSignedIn
                    ? sidebarElement("Logout", Icons.logout, false, () => _sendToLogout(context))
                    : sidebarElement("Login", Icons.login, false, () => _sendToLogin(context))
              ]
            )
          )
        ]
